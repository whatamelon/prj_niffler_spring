  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingOne1">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="false"
        ...
        <h6 class="mb-0">
          로그인이 안돼요. <i class="fas fa-angle-down rotate-icon"></i>
        </h6>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingTwo2">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
        ...
        <h6 class="mb-0">
          어떻게 사용하죠?<i class="fas fa-angle-down rotate-icon"></i>
        </h6>
      </a>
    </div>
    ...
    <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2" data-parent="#accordionEx">
      <div class="card-body">
        날씨 잘 보시구, 구글 트렌드 잘 활용하시구, 그 날 그 날 기분에 따라 활용하시면 됩니다!
      </div>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree3">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
        ...
        <h6 class="mb-0">
          업데이트 안하나요? <i class="fas fa-angle-down rotate-icon"></i>
        </h6>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree4">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree4"
        ...
        <h6 class="mb-0">
          날씨는 어떻게 봐요? <i class="fas fa-angle-down rotate-icon"></i>
        </h6>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree5">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree5"
        ...
        <h6 class="mb-0">
         회원탈퇴는 어떻게 하죠? <i class="fas fa-angle-down rotate-icon"></i>
        </h6>
      </a>
    </div>
    ...
    <div id="collapseThree5" class="collapse" role="tabpanel" aria-labelledby="headingThree5" data-parent="#accordionEx">
      <div class="card-body">
        로그인 하시면 인트로에 회원탈퇴 부분이 있습니다! 안녕히가세요!
      </div>
    </div>

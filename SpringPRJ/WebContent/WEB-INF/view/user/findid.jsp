								...
								<div class="table-responsive">
									<div class="col-md-12">
										<div class="card">
											...
											<div class="card-body">
												<form action="/user/findidProc.do" id="submitForm">
													<div class="row">
														<div class="col-md-4 pr-1">
															<div class="form-group">
																<label style="font-size: 1.2571em;">이름</label> <input type="text" class="form-control" name="name" id="name" placeholder="이름(한글로 입력해주세요.)" required />
															</div>
														</div>
														<div class="col-md-4 pl-1">
															<div class="form-group">
																<label style="font-size: 1.2571em;">생년월일</label> <input type="number" class="form-control" name="birthdate" id="birth" placeholder="생년월일 ex)19990101" required />
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-12">
															<button type="button" onclick="check()" value=findid2로넘어가기 class="button">아이디찾기</button>
														</div>
													</div>
												</form>
											</div>

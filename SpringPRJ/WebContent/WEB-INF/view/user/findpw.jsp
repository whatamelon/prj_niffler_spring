        ...
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <div class="navbar-toggle">
             ...
             <p style="font-size:15pt;">비밀번호찾기</p>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">비밀번호찾기</h5>
              </div>
              <div class="card-body">
                <form action="/user/findpwProc.do" id="submitForm">
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="birthdate" id="birth" placeholder="생년월일 ex)19990101" required/>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  	<div class="col-md-12">
                  	<button type="button" onclick="check()" value=findpw2로넘어가기 class="button">비밀번호찾기</button>
                  	</div>
                  </div>
                </form>
              </div>

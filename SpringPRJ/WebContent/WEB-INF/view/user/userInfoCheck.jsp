          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="title">회원정보수정</h5>
              </div>
              <div class="card-body">
              <form action="/user/userInfoCheckProc.do" method=post id="submitForm">
                	 <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        <label style="font-size:1.2571em;">회원님의 비밀번호 : </label>
                        <input id="pwd" type="password" name="password" class="form-control" placeholder="비밀번호" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  	<div class="col-md-12">
                  	<button type="submit"  value=회원정보수정 class="button">확인</button>
                  	</div>
                  </div>
                  </form>
              </div>

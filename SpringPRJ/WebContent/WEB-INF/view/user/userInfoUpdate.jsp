        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="/user/userInfoUpdateProc.do" id="submitForm" method="POST">
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                      	<input type="hidden" name="usr_seq_no" value="<%=uDTO.getUsr_no() %>">
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="password" id="password" class="form-control" value="<%=uDTO.getUsr_password() %>" />
                      </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="pwdChk" id="pwdChk" class="form-control" value="<%=uDTO.getUsr_password() %>" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="usr_nickname" id="nickname" class="form-control" value="<%=uDTO.getUsr_name() %>" />
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label style="font-size:1.2571em;">생년월일</label>
                        <input type="text" name="usr_birthdate" id="birthdate"class="form-control" value="<%=uDTO.getUsr_age() %>" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  	<div class="col-md-12">
                  	<button type="button" onclick="javascript:check(); return false;" value=회원정보수정 class="button">수정하기</button>
                  	</div>
                  </div>
                </form>
              </div>

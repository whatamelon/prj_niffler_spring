...
//------------------------- 일반차트 설정 시작 ---------------------------
 ...
 // ------------------------- 빨강차트 시작  (이 쪽은 아무리 바꿔도 안바뀜 그니까 건들지 말장)---------------------------
 ...
 // ------------------------- 빨강차트 끝(이 쪽은 아무리 바꿔도 안바뀜 그니까 건들지 말장) ---------------------------
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          pointHoverBackgroundColor: "#E8D9FF",
      ...
      options: {
        ...
        maintainAspectRatio: false,     // 보더 세션
        tooltips: {
          backgroundColor: '#fff',
          titleFontColor: '#333',
          bodyFontColor: '#666',
